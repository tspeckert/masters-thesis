...
New forms of organizational structure enabled uniquely by modern information and communication technologies  Internet emerged recently:  collaborative networks~\cite{Camarinha-Matos2005}, virtual (boundaryless) organizations \cite{?????} and coopetition~\cite{Bengtsson2000}.
...
\caption{Organizational taxonomy: SOME TEXT COMES HERE}
\label{fig:taxonomy}
\end{figure}
