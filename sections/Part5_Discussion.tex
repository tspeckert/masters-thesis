...
In terms of IT governance, the as-is, centralized, and peer production frameworks are each vastly different from one another. With completely centralized IT, the department IT would be a subordinate entity to the central IT (or even not exist at all). 
