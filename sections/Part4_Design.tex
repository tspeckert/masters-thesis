...
\item Collaboration with outside institutions managed by the department  itself, no SU involvement %Uno

\item Collaboration with other departments/faculties managed entirely by the department %Uno
...
\end{itemize}
\subparagraph*{Information Technology}
\begin{itemize}
