...
As the main identified issue in case is with decision making, a governance framework based on peer production and focusing on IT will be developed to address this. 
