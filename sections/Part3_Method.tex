...
This thesis work, being much smaller in scale than an entire EA framework, will focus on the creation of \textit{guidelines} (method artifact type) for supporting decentralization in EA.
...
In the Apply Artifact sub-activity, three separate architectures are outlined: the As-Is architecture of the case, a To-Be architecture of the developed with the artifact, and a To-Be architecture based on traditional EA knowledge. 
...
%
%maintain clarity about purpose of thesis?
%remain unbiased in interviewing
%hide identity
% limiting to 3 frameworks

%On moral grounds, this expectation stems from the belief that the public should be protected from researchers who might be tempted to use any means available to advance the state of knowledge on a given topic.
%DONT LET WHAT I WANT OUT OF THIS EFFECT CONCLUSIONS

%Denscombe, Martyn (2011-02-08). The Good Research Guide: For Small-Scale Social Research Projects (Kindle Locations 6376-6377). McGraw Hill International. Kindle Edition. 
...
%in all interviews, the beliefs of the interviewers were not pushed upon the interviewees. 
%interviewers did not try to manipulate the responses by pushing thei
%
%the ethical considerations for this research project are minimal and only involve withholding the identity of the case institution. 
