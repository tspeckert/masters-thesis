...
This thesis addresses the problem of a suitable EA for decentralized organizations. The goal here is not to create a new EA framework, but rather to enhance existing ones through guidelines or principles that increase their support for decentralized business environments.
