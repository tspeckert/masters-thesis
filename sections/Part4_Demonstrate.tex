...
%
 ...
 Coordination &
 Decentralized & 
 Department IT does not dictate all IT used in the department, research projects and centers, for example, can develop and use their own IT systems should they desire\footnote{From the interview with the head of PhD studies\label{fn:interviewPHD}}\footref{fn:interviewIT}. \\
