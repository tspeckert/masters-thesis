...
%
 ...
 \textit{Coordination} &
 \textit{Centralized} &
 \textit{Department-level board responsible for department-wide budgeting. This follows the guidelines of ``decentralized authority structure'' and ``willful coordination'' by removing the centralized strategic direction setting in the department.} \\
%
\hline
%
 \textit{Budgeting} &
...
%
 ...
 \textit{Coordination} &
 \textit{Mixed} &
 \textit{Department members collaboratively set specific operating principles for the department on a yearly basis that need to be approved by the Faculty. This follows the guidelines of ``peer decision making'' and ``willful coordination'' where the department members work together to decide on their operating principles; i.e. this decision involves all faculty members, instead of just the department head or board.} \\
%
\hline
%
%
 ...
 \textit{Coordination} &
 \textit{Mixed} &
 \textit{Department members collaboratively set general strategy and vision for the department every three years that need to be approved by the Faculty. This also follows the guidelines of ``peer decision making'' and ``willful coordination''.} \\
%
\hline
%%
%%
...
\textit{Management of non-essential central systems} &
 \textit{Coordination} &
 \textit{Mixed} &
 \textit{Departments have the choice to opt-in to these systems. Those who choose not to opt-in do not pay for them. This follows the guideline of ``willful coordination''.}  \\
%
\hline
%
\end{longtable}
