...
% I applied the 3 guidelines to different aspects of governance at DSV (taken from the interviews/document study). I started with the how it is (As-Is), applied the guidelines to come up with 4.8 and 4.9, and made tables 4.6 and 4.7 based on the EA study. 
...
The implementation of the Architecture Principles in an organization heavily depends on the specifics of that organization.
