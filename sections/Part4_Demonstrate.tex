...
The three architecture principals which compose the solution artifact are demonstrated through the development of three governance frameworks: an ``as-is'' governance framework reflecting the case organization's current state (tables \ref{table:as-isGeneralGovernance} and \ref{table:as-isITGovernance}); a ``to-be'' centralized governance framework using traditional EA concepts (tables \ref{table:centralGeneralGovernance} and \ref{table:centralITGovernance}); and a ``to-be'' decentralized governance framework where the three architecture principals are used as guidelines for its development (tables \ref{table:peerGeneralGovernance} and \ref{table:peerITGovernance}). Both of the to-be frameworks are aimed at addressing issues in decision making identified in the case organization. 
...
%
 ...
 \textit{Centralized} &
 \textit{A group composed of upper level management from the different areas (e.g. the head of undergraduate studies) of the department advise the department head. This is consistent with the general theme of vertical coordination present in EA, for example, TOGAF's suggestion of a central architecture board consisting of senior management.} \\ %similar to FEA value measurement process, though FEA is decent.
%
\hline
%
%
...
%
 ...
 \textit{Coordination} &
 \textit{Centralized} &
 \textit{Department-level board responsible for department-wide budgeting. This follows the principles of ``decentralized authority structure'' and ``wilful coordination'' by removing the centralized strategic direction setting in the department.} \\
%
\hline
%
 \textit{Budgeting} &
...
%
 ...
 \textit{Coordination} &
 \textit{Mixed} &
 \textit{Department members collaboratively set specific operating principles for the department on a yearly basis that need to be approved by the Faculty. This follows the principles of ``peer decision making'' and ``wilful coordination'' where the department members work together to decide on their operating principles; i.e. this decision involves all faculty members, instead of just the department head or board.} \\
%
\hline
%
%
 ...
 \textit{Coordination} &
 \textit{Mixed} &
 \textit{Department members collaboratively set general strategy and vision for the department every three years that need to be approved by the Faculty. This also follows the principles of ``peer decision making'' and ``wilful coordination''.} \\
%
\hline
%%
%%
...
\textit{Management of non-essential central systems} &
 \textit{Coordination} &
 \textit{Mixed} &
 \textit{Departments have the choice to opt-in to these systems. Those who choose not to opt-in do not pay for them. This follows the principle of ``wilful coordination''.}  \\
%
\hline
%
\end{longtable}
