...
%Decentralization transforms the role of company's authority and makes relationships inside and between different company's divisions much more complex. Planning and governance in different functional areas, including IT,  is not anymore ensured centrally. As a consequence, collaboration and information sharing between subunits gain extreme importance. 

%Modern organizations are trending towards decentralization - where organizational units and individuals are being given an increasing amount of autonomy and control over an enterprise's direction and operations.
...
%The contribution of this paper is twofold: first, we analyze various forms of organizational structures,  outline the main characteristics of decentralization and identify the challenges related to decentralization in organizational IT; second, we asses the three prevalent EA methodologies and their capacity to support the decentralization.
...
%The main contribution of this paper is a classification of organizational forms, used further to assess the prevalent EA methodologies and their obstacles in supporting decentralization, leading finally to a set of recommendations for decentralized-aware EA.
