...
%\hline
%
%& \textbf{Existing support for centralized organizations} & \textbf{Existing support for decentralized organizations} &  \textbf{Applicable P2P principles for a solution} \\
%
%\hline
%
%\textbf{EA Method:} & Approval process & federated architectures; flexible ADM & peer production; P2P trust management \\
%
%\hline
%
%\textbf{EA Description:} & Strategic level architectures; overarching architecture principles; architecture repository & Architecture partitions; architecture reference models & -- \\
%
%\hline
%
%
%\textbf{EA Engine:} & Architecture board; formal governance framework &  &    \\
%
%\hline
%
%\end{tabular}
