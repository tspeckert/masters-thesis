...
This thesis is not aiming at effecting change in this institution. The focus is instead on: analyzing the state of its EA in order to assess the decentralization support provided in contrast with what is needed; and proposing an EA that can provide the needed support. 
...
%TODO CHANGE TENSE TO PRESENT
\subsubsection*{Iterations Between Activities}

1-2-3 (literature study only)
1-2-3-4 (case)
