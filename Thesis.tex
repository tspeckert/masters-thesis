...
\documentclass[12pt, a4, oneside, openright]{book}
...
%customize captions
\captionsetup{font=small,labelfont=it,singlelinecheck=off}
...
\usepackage{longtable} %for long tables ...duh
%Customizing longtable captions... dunno:
%
...
\begin{document}
    ...
    \input{sections/Part1_Background.tex}

    \section{Problem}
    \label{sec:problem}    
    \input{sections/Part1_Problem.tex}
    
%    \section{Goals and Purpose}
%    \label{sec:resq}
%    \input{sections/Part1_Goals.tex}
        
    \section{Research Questions}
    \label{sec:resq}
    \input{sections/Part1_ResearchQuestions.tex}
    
    \section{Limitations}
    \label{sec:limit}
    \input{sections/Part1_Limitations.tex}
    
    \section{Chapter Layout}
    \label{sec:layout}
    \input{sections/Part1_Layout.tex}
    ...
    \input{sections/Part2_DecentralizedOrgs.tex}   
    
    \section{Enterprise Modeling: A ``Light-Weight'' Alternative to Enterprise Architecture}
    \label{sec:related}
    \input{sections/Part2_RelatedWorks.tex}
    
    % Part 3 - Method    
    
    \chapter{Method}
    \label{chap:method}
    \input{sections/Part3_Method.tex}
    
    %Part 4 - Results
    
    \chapter{Results}
    \label{chap:results}  
    \input{sections/Part4_Intro.tex}
    
    \section{Explicate Problem}    
    \label{sec:exproblem}
    \input{sections/Part4_Explicate.tex}
    
    \section{Outline Artifact and Define Requirements}
    \label{sec:outline}
    \input{sections/Part4_Outline.tex}    
    
    \section{Design and Develop Artifact}
    \label{sec:design}
    \input{sections/Part4_Design.tex}
    
    \section{Demonstrate Artifact}
    \label{sec:demo}
    \input{sections/Part4_Demonstrate.tex}
    
    \section{Evaluate Artifact}
    \label{sec:evaluate}
    \input{sections/Part4_Evaluate.tex}  
    ...
    \input{sections/Part5_Conclusions}
    
    \section{Discussion}
    \label{sec:discussion}
    \input{sections/Part5_Discussion}
    
    \section{Future Work}
    \label{sec:future}
    \input{sections/Part5_Future}
...
%    \bibliography{biblioDecentralizedEA}
    ...
    \input{sections/Appendix_Questions}
